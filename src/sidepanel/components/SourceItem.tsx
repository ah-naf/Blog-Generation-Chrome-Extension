...
interface SourceItemProps {
  ...
  onRefine: (source: SourceContent, forceRefresh?: boolean) => void;
  onUndoRefinement: (id: string) => void;
...
export function SourceItem({
  ...
  return (
    <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 last:border-0">
      {/* Accordion header */}
      <div
